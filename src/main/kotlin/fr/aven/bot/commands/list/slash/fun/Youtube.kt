...
class Youtube: ISlashCmd
{
    override suspend fun action(event: SlashCommandInteractionEvent, lang: LangManager) {
        val invite = Activities.createInvite("youtube", event.member?.voiceState?.channel?: return event
    ...
    override val description: String
        get() = "Starts YouTube Together in your channel"
}