...
class Fishington: ISlashCmd
{
    override suspend fun action(event: SlashCommandInteractionEvent, lang: LangManager) {
        val invite = Activities.createInvite("fishington", event.member?.voiceState?.channel?: return event
    ...
    override val description: String
        get() = "Starts Fishington in your channel"
}